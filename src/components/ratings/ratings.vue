<template>
  <div class="ratings" ref="scroll">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect @toggle="onToggle" @select="onSelect" :select-type="selectType" :only-content="onlyContent" :rating="ratings"></ratingselect>
          ...
          <li v-for="(rating,index) in ratings" :key="index" v-show="needShow(rating.rateType,rating.text)" class="rating-item">
            ...
            <div class="content">
              ...
              <div class="recommend" v-show="rating.recommend && rating.recommend.length">
                ...
                <span v-for="(item,cindex) in ratings[index].recommend" :key="cindex" class="item">{{item}}</span>
              </div>
              <div class="time">
